                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="../assets/images/logoimg.png" style="margin-left: -20px" width="90" height="" alt="50" homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                        ...
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="../assets/images/logoletra.png" style="margin-left: -20px" height="50" width="190" alt="homepage" class="dark-logo" />
                         <!-- Light Logo text -->    
