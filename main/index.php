                        ...
                        <form class="form-horizontal form-material" id="loginform" action="index.php">
                            ...
                            <div class="form-group text-center">
                                <div class="col-xs-12 p-b-20">
                                    <button style="background-color: #20AEE3;color: white;font-weight: bolder" class="btn btn-block btn-lg  btn-rounded" type="submit"><img id="imgLoaderPass" src="../assets/images/spinner/Loader_BK_SVG.svg" alt="x" width="28" height="18" /> Ingresar</button>
                                </div>
                            </div>
